...
activities = {
    ...
    "Basketball Club": {
        "description": "Train basketball skills and play friendly matches",
    ...
    "Drama Club": {
        "description": "Rehearse and perform theatrical plays and improvisation",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate student is not already signed up, then add them to the activity
